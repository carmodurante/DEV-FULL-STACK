...
def make_window(theme=None):
    ...
    layout = [[sg.MenubarCustom([['File', ['Exit']], ['Edit', ['Edit Me', ]]], k='-CUST MENUBAR-',
        ...
        sg.Menu([['File', ['Exit']], ['Edit', ['Edit Me', ]]], k='-CUST MENUBAR-', p=0)],
              ...
              [sg.T('Interfaces Gui Elements - Use Combo to Change Themes', font='_ 18', justification='c',
                    expand_x=True)],
              [sg.Col(layout_l), sg.Col(layout_r)]]

    window = sg.Window('The Interfaces Gui Element List', layout, finalize=True,
